  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-3 px-4 h-16 border-b border-sidebar-border">
        ...
        {!collapsed && (
          <div>
            <h1 className="text-sm font-bold text-foreground tracking-wide">NULL BREACH</h1>
            <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Cyber Defense</p>
          </div>
        )}
      </div>
          ...
          <>
            ...
            <button
              ...
              className={cn(
                ...
                isSimulating ? "bg-success/10 text-success" : "bg-muted text-muted-foreground"
              )}
            >
